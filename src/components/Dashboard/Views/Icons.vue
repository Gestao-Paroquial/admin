      ...
      <div class="card">
        ...
        <div class="content all-icons">
          ...
          <div class="icon-section">
            ...
            <div class="icon-container">
              <span class="ti-arrow-down"/>
              <span class="icon-name"> ti-arrow-down</span>
            </div>
            <div class="icon-container">
              <span class="ti-arrows-vertical"/>
              <span class="icon-name"> ti-arrows-vertical</span>
            </div>
            <div class="icon-container">
              <span class="ti-arrows-horizontal"/>
            ...
            <div class="icon-container">
              <span class="ti-back-left"/>
              <span class="icon-name"> ti-back-left</span>
            </div>
            <div class="icon-container">
              <span class="ti-exchange-vertical"/>
          ...
          <div class="icon-section">
            ...
            <div class="icon-container">
              <span class="ti-desktop"/>
              <span class="icon-name"> ti-desktop</span>
            </div>
            <div class="icon-container">
              <span class="ti-tablet"/>
            ...
            <div class="icon-container">
              <span class="ti-shopping-cart-full"/>
            ...
            <div class="icon-container">
              <span class="ti-zoom-in"/>
              <span class="icon-name"> ti-zoom-in</span>
            </div>
            <div class="icon-container">
              <span class="ti-zoom-out"/>
            ...
            <div class="icon-container">
              <span class="ti-paint-roller"/>
              <span class="icon-name"> ti-paint-roller</span>
            </div>
            <div class="icon-container">
              <span class="ti-paint-bucket"/>
            ...
            <div class="icon-container">
              <span class="ti-flag-alt"/>
              <span class="icon-name"> ti-flag-alt</span>
            </div>
            <div class="icon-container">
              <span class="ti-flag-alt-2"/>
            ...
            <div class="icon-container">
              <span class="ti-comment-alt"/>
              <span class="icon-name"> ti-comment-alt</span>
            </div>
            <div class="icon-container">
              <span class="ti-thought"/>
            ...
            <div class="icon-container">
              <span class="ti-notepad"/>
              <span class="icon-name"> ti-notepad</span>
            </div>
            <div class="icon-container">
              <span class="ti-server"/>
            ...
            <div class="icon-container">
              <span class="ti-envelope"/>
              <span class="icon-name"> ti-envelope</span>
            </div>

            <div class="icon-container">
              <span class="ti-dashboard"/>
            ...
            <div class="icon-container">
              <span class="ti-cloud-down"/>
              <span class="icon-name"> ti-cloud-down</span>
            </div>
            <div class="icon-container">
              <span class="ti-clipboard"/>
            ...
            <div class="icon-container">
              <span class="ti-bar-chart-alt"/>
              <span class="icon-name"> ti-bar-chart-alt</span>
            </div>

            <div class="icon-container">
              <span class="ti-archive"/>
            ...
            <div class="icon-container">
              <span class="ti-help-alt"/>
              <span class="icon-name"> ti-help-alt</span>
            </div>
            <div class="icon-container">
              <span class="ti-headphone-alt"/>
            ...
            <div class="icon-container">
              <span class="ti-face-sad"/>
              <span class="icon-name"> ti-face-sad</span>
            </div>
            <div class="icon-container">
              <span class="ti-credit-card"/>
          ...
          <div class="icon-section">
            ...
            <div class="icon-container">
              <span class="ti-Italic"/>
              <span class="icon-name"> ti-Italic</span>
            </div>
            <div class="icon-container">
              <span class="ti-smallcap"/>
          ...
          <div class="icon-section">
            ...
            <div class="icon-container">
              <span class="ti-view-list-alt"/>
              <span class="icon-name"> ti-view-list-alt</span>
            </div>
            <div class="icon-container">
              <span class="ti-view-grid"/>
          ...
          <div class="icon-section">
            ...
            <div class="icon-container">
              <span class="ti-flickr"/>
              <span class="icon-name"> ti-flickr</span>
            </div>
            <div class="icon-container">
              <span class="ti-flickr-alt"/>
            ...
            <div class="icon-container">
              <span class="ti-dropbox"/>
              <span class="icon-name"> ti-dropbox</span>
            </div>
            <div class="icon-container">
              <span class="ti-dropbox-alt"/>
            ...
            <div class="icon-container">
              <span class="ti-jsfiddle"/>
              <span class="icon-name"> ti-jsfiddle</span>
            </div>
            <div class="icon-container">
              <span class="ti-joomla"/>
