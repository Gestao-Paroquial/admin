<template>
  <div class="col-md-12" >
    <modal :show-modal="showModalAdd" :close-modal="closeModalAdd" :title="'Adicionar Dizimista'">
      <simple-form slot="body" :inputs="inputs" :action="add" :btn-msg="'Adicionar'" :btn-class="'btn-fill btn-info btn-wd'"/>
    </modal>
    <modal :show-modal="showModalUpdate" :close-modal="closeModalUpdate" :title="'Alterar Dizimista'">
